...
Generated at: 2026-03-12T06:48:02.618989+00:00
Project: shop-0311-4
Milestone: 3
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Create a user, category, product with inventory, then create an order and verify it succeeds with correct total and status",
        "setup": {
            "steps": [
                {
                    "id": "user",
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Create an order with multiple different products and verify the total is calculated correctly",
        "setup": {
            "steps": [
                {
                    "id": "user",
                    ...
                    "method": "POST",
                    "body": {
                        "email": "multi-item-user@example.com",
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Attempt to create an order with a non-existent user ID and expect 404",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Attempt to create an order with a valid user but a non-existent product ID and expect 404",
        "setup": {
            "steps": [
                {
                    "id": "user",
                    ...
                    "method": "POST",
                    "body": {
                        "email": "prod-notfound-user@example.com",
                        "name": "Prod NotFound User"
                    },
                    "extract_id_from": "id"
                }
            ]
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Attempt to order more than available inventory and expect 400",
        "setup": {
            "steps": [
                {
                    "id": "user",
                    ...
                    "method": "POST",
                    "body": {
                        "email": "inventory-fail-user@example.com",
                        "name": "Inventory Fail User"
                    },
                    "extract_id_from": "id"
                },
                {
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a full order then retrieve it by ID and verify the response includes user name and item details",
        "setup": {
            "steps": [
                {
                    "id": "user",
    ...
    },
    {
        ...
        "endpoint": "/orders/{order_id}",
        "method": "GET",
        "description": "Attempt to retrieve an order with a non-existent ID and expect 404",
        "request_data": {
            "path": {
                "order_id": 999999
            },
    ...
    },
    {
        ...
        "endpoint": "/orders",
        "method": "POST",
        "description": "Attempt to create an order without the required items field and expect 422 validation error",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
