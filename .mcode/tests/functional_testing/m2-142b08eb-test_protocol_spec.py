...
Generated at: 2026-03-12T06:44:55.234440+00:00
Project: shop-0311-4
Milestone: 2
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Create a product without a category_id (optional field)",
        "request_data": {
            "path": {},
            "query": {},
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/products/{product_id}",
        "method": "GET",
        "description": "Attempt to get a product that does not exist, expect 404",
        "request_data": {
            "path": {
                "product_id": 999999
            },
    ...
    },
    {
        ...
        "method": "GET",
        "description": "Create a product (which auto-initializes inventory), then get its inventory",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/inventory/{product_id}/reserve",
        "method": "POST",
        "description": "Create a product (inventory auto-initialized at 0), attempt to reserve units \u2014 expect 400 insufficient inventory",
        "setup": {
            "endpoint": "/products",
            "method": "POST",
            "body": {
...
BASE_URL = os.path.expandvars("http://localhost:8765")
