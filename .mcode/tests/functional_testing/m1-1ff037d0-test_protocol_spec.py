...
Generated at: 2026-03-12T06:52:32.137519+00:00
Project: shop-0311-4
Milestone: 1
"""
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    json.loads(r'''[
    {
        ...
        "endpoint": "/",
        "method": "GET",
        "description": "Verify the health check endpoint returns healthy status",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "List all users and verify the response is an array",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "Create a user then list users to verify it appears",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
